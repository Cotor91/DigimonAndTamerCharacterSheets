    ...
    public partial class Form1 : Form
    {
        ...
        private void Digivolve_Click(object sender, EventArgs e)
        {
            ...
            // Check Dark Digivolution Odds
            {
                ...
                int.TryParse(StrengthDiet.Text, out DietStrength);
                int.TryParse(AgilityDiet.Text, out DietAgility);
                int.TryParse(VibesDiet.Text, out DietVibes);
                int.TryParse(WitsDiet.Text, out DietWits);
                int.TryParse(EducationDiet.Text, out DietEducation);
                String MaxDiet = "";

                // Diet comparisons
                // Strength VS Agility
                if (DietStrength > DietAgility)
                {
                    // Strength Won
                    // Vibes VS Wits
                    if (DietVibes > DietWits)
                    {
                        // Vibes Won
                        // Vibes VS Strength
                        if (DietVibes > DietStrength)
                        {
                            // Vibes Won
                            // Vibes VS Education
                            if (DietVibes > DietEducation)
                            {
                                // Vibes Won
                                MaxDiet = "DietVibes";
                            }
                            ...
                            {
                                // Education Won
                                MaxDiet = "DietEducation";
                            };
                        }
                        else
                        {
                            // Strength Won
                            // Strength VS Education
                            if (DietStrength > DietEducation)
                            {
                                // Wits Won
                                // Strength VS Wits
                                MaxDiet = "DietStrength";
                            }
                            else
                            {
                                MaxDiet = "DietEducation";
                    ...
                    else
                    {
                        // Wits Won
                        // Wits VS Strength
                        if (DietWits > DietStrength)
                        {
                            // Wits Won
                            // Wits VS Education
                            if (DietWits > DietEducation)
                            {
                                // Wits Won
                                MaxDiet = "DietWits";
                            }
                ...
                else
                {
                    ...
                    if (DietVibes > DietWits)
                    {
                        ...
                        {
                            // Agility Won
                            // Agility VS Education
                            if (DietAgility > DietEducation)
                            {
                                // Wits Won
                                // Agility VS Wits
                                MaxDiet = "DietAgility";
